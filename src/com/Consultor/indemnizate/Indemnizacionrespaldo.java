...
public class Indemnizacionrespaldo extends SherlockActivity {
...
public void calculaIL (View view) {
			...
			if ((etSueldo.getText().toString().length() == 0)||(etAntiguedad.getText().toString() .length() == 0)) { //Si alguno es vacío 
				...
				if((nSueldo == 0)||(nAntiguedad <= 0)||(nAntiguedad >= 50)) {
					...
					//Para formato del sueldo una vez que oprimo el botón calcular
